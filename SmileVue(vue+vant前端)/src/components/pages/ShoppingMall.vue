  ...
  <div>
    ...
    <div class="swiper-area">
      <van-swipe :autoplay="3000">
        <van-swipe-item v-for="(banner,index) in bannerArray" :key="index"  @click="goGoods">
    ...
    <!--type bar-->
      <div class="type-bar">
          <div v-for="(cate,index) in category" :key="index" @click="goGoods">
      ...
      <div class="recommend-body">
         <swiper :options="swiperOption">
           <swiper-slide v-for="(goods,index) in recommendGoods" :key="index" >
              <div class="recommend-item" @click="goGoods">
                <img :src="goods.image" width="80%">
                <div>{{goods.goodsName}}</div>
                <div>¥ {{goods.price | moneyFilter}}(¥{{goods.mallPrice | moneyFilter}})</div>
              </div>
           </swiper-slide>
         </swiper>
      </div>
  ...
  export default {
        ...
        data(){
          return {
            ...
            category:[
              {"mallCategoryName": "新鲜水果", "image": "http://images.baixingliangfan.cn/firstCategoryPicture/20180408/20180408113048_1276.png"},
              {"mallCategoryName": "其他食品", "image": "http://images.baixingliangfan.cn/firstCategoryPicture/20180408/20180408112010_4489.png"},
              {"mallCategoryName": "营养奶品", "image": "http://images.baixingliangfan.cn/firstCategoryPicture/20180408/20180408113102_1595.png"},
              {"mallCategoryName": "食品饮料", "image": "http://images.baixingliangfan.cn/firstCategoryPicture/20180408/20180408113048_1276.png"},
              {"mallCategoryName": "个人护理", "image": "http://images.baixingliangfan.cn/firstCategoryPicture/20180408/20180408112053_8191.png"},
            ],
       ...
       /*   axios({
          ...
          .then(response=>{
            if(response.status==200){
               this.category=response.data.data.category;//轮播下方导航
               this.adBanner = response.data.data.advertesPicture;//广告条
               this.bannerArray=response.data.data.slides;//轮播图
